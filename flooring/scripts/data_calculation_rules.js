calculation_rules =  {
	...
	"number_of_fasteners": function() {
		...
		var number_of_fasteners = number_of_fasteners_per_sheet[sheet_type] * number_of_sheets;
		return number_of_fasteners;
	},
	"amount_of_epoxy": function() {
		var sheet_type = $("#step1\\[sheet_size\\]").val();	
		var number_of_sheets = $("#step3\\[number_of_sheets\\]").val();	
		var amount_of_epoxy = amount_of_epoxy_per_sheet[sheet_type] * number_of_sheets;
	...
	"amount_of_constr_adhesive": function() {
		var sheet_type = $("#step1\\[sheet_size\\]").val();	
		var number_of_sheets = $("#step3\\[number_of_sheets\\]").val();	
		var amount_of_constr_adhesive = amount_of_constr_adhesive_per_sheet[sheet_type] * number_of_sheets;
